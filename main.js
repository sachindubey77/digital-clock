...
const ShowMsgs=()=>{
    ...
    if(arr1[0]==ph && arr1[1]==a.innerText){
        ...
        document.getElementById("timeMsg2").innerHTML="<h2>utho laal ab aankhen kholo</h2>"
        ...
        document.getElementById("timeMsg2").innerHTML="<h2>Its Night Time,So jaao raat ho gayi</h2>"
